...
```
The gsmr source codes are available in [gsmr_${VER}.tar.gz](http://cnsgenomics.com/software/gsmr/static/gsmr_${VER}.tar.gz). Sample data are available in [test_data.zip](http://cnsgenomics.com/software/gsmr/static/test_data.zip).
...
heidi_outlier_thresh = 0.05    # HEIDI-outlier threshold
