...
```
## Overview
The **gsmr** R-package implements the GSMR (Generalised Summary-data-based Mendelian Randomisation) method to test for putative causal association between a risk factor and a disease using summary-level data from genome-wide association studies (GWAS)^1^. The R package is developed by [Zhihong Zhu](mailto:z.zhu1@uq.edu.au), [Zhili Zheng](mailto:zhilizheng@outlook.com), [Futao Zhang](mailto:futao.zhang@uq.edu.au) and [Jian Yang](http://researchers.uq.edu.au/researcher/2713) at Institute for Molecular Bioscience, the University of Queensland. Bug reports or questions: [jian.yang@uq.edu.au](mailto:jian.yang@uq.edu.au).

### Citation

Zhu, Z. et al. Causal associations between risk factors and common diseases inferred from GWAS summary data. [bioRxiv, 168674](https://www.biorxiv.org/content/early/2017/07/26/168674).
...
gsmr_results = gsmr(bzx, bzx_se, bzx_pval, bzy, bzy_se, ldrho, snp_coeff_id, heidi_outlier_flag, gwas_thresh, heidi_outlier_thresh, nsnps_thresh)    # GSMR analysis
...
```{r message=FALSE, warning=FALSE}
filtered_index = heidi_outlier(bzx, bzx_se, bzx_pval, bzy, bzy_se, ldrho, snp_coeff_id, gwas_thresh, heidi_outlier_thresh, nsnps_thresh) # perform HEIDI-outlier analysis
...
```{r message=FALSE, warning=FALSE}
gsmr_results = bi_gsmr(bzx, bzx_se, bzx_pval, bzy, bzy_se, bzy_pval, ldrho, snp_coeff_id, heidi_outlier_flag, gwas_thresh, heidi_outlier_thresh)    # GSMR analysis 
