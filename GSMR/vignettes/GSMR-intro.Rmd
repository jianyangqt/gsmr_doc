...
## Source code
[gsmr_${VER}.tar.gz](http://cnsgenomics.com/software/gsmr/static/gsmr_${VER}.tar.gz)

Note: GSMR 1.0.8 includes a new HEIDI-outlier method that is currently under development and subject to future changes. Details of the new HEIDI-outlier method will be included in the next GSMR paper.
...
V1.0.8 ([gmr_1.0.8.tar.gz](http://cnsgenomics.com/software/gsmr/static/gsmr_1.0.8.tar.gz) [PDF](http://cnsgenomics.com/software/gsmr/static/gsmr_doc_1.0.8.pdf), 10 Dec. 2018): Using the original HEIDI-outlier method described in [Zhu et al. (2018 Nature Communications)](https://www.nature.com/articles/s41467-017-02317-2).

V1.0.7 ([gmr_1.0.7.tar.gz](http://cnsgenomics.com/software/gsmr/static/gsmr_1.0.7.tar.gz) [PDF](http://cnsgenomics.com/software/gsmr/static/gsmr_doc_1.0.7.pdf), 9 Oct. 2018): Add a multi-SNP-based HEIDI-outlier test in the HEIDI-outlier analysis.
...
gsmr_results = gsmr(bzx, bzx_se, bzx_pval, bzy, bzy_se, ldrho, snp_coeff_id, n_ref, heidi_outlier_flag, gwas_thresh, heidi_outlier_thresh, nsnps_thresh, ld_r2_thresh, ld_fdr_thresh, gsmr_beta)    # GSMR analysis 
